...
func makeFilterFormsEndpoint(s service.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
...
func makeListFormsEndpoint(s service.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		formList, err := s.ListForms(req.Ctx, req.Type, req.Status, req.SearchParam.Page, req.SearchParam.PageSize, req.SearchParam)
		if err != nil {
			return nil, err // or wrap as needed
		}
		return formList, nil
...
func makeUpdateFormStatusEndpoint(s service.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(*dto.UpdateFormRequest)
		fmt.Println("Form ID:", req.ID)
		fmt.Println("Form Status:", req.Status)

		form, err := s.UpdateFormStatus(req.Ctx, req.ID, req.Status)
		if err != nil {
			return nil, err
		}
		return form, nil
